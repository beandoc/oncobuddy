  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 h-full pb-20 animate-in fade-in duration-700">
      ...
      <div className="w-full lg:w-80 space-y-8">
         <GlassCard className="!p-6 border-slate-100 bg-white shadow-xl shadow-slate-100/50">
            <div className="flex items-center justify-between mb-8">
               <h3 className="text-lg font-bold font-outfit text-slate-900 leading-none italic italic">Schedule <span className="text-indigo-600">Sync</span></h3>
            ...
            <div className="pt-6 border-t border-slate-50 space-y-4">
               <div className="flex items-center justify-between">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">EMR Connection</p>
               ...
               <p className="text-[10px] text-slate-500 italic italic leading-relaxed">External FHIR sync active. 4 updates since login.</p>
         ...
         <GlassCard className="!p-6 border-amber-100 bg-amber-50/20 shadow-none">
            <h4 className="text-xs font-black uppercase text-amber-600 tracking-widest mb-3 flex items-center gap-2">
               <AlertCircle className="w-3.5 h-3.5" /> High Precision Tasks
            </h4>
            <div className="space-y-4">
               <div className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-1.5" />
                  <p className="text-[10px] text-amber-900 font-medium leading-relaxed italic italic">Review preparation labs for Mr. J. Doe (10:30am appt).</p>
               </div>
               <div className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-1.5" />
                  <p className="text-[10px] text-amber-900 font-medium leading-relaxed italic italic">Confirm infusion chair availability for Screen 14.</p>
               </div>
            </div>
         </GlassCard>
      </div>
      ...
      <div className="flex-1 space-y-8">
         <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
               <h1 className="text-4xl font-bold font-outfit tracking-tight text-slate-900 italic italic">Clinical <span className="text-indigo-600">Timeline</span></h1>
               <p className="text-slate-500 font-medium italic italic">Friday, October 12th — Panel Visibility Active.</p>
            </div>
            <Button variant="secondary" className="h-12 px-8 gap-3 bg-slate-950 font-black text-[11px] uppercase tracking-widest shadow-2xl transition-all">
      ...
      <div className="w-full lg:w-96 space-y-8 bg-slate-50/50 p-8 rounded-[40px] border border-slate-100 shadow-inner">
         <div className="space-y-2">
            <h3 className="text-xl font-bold font-outfit text-slate-900 border-b border-indigo-100 pb-2 italic italic">Preparation <span className="text-indigo-600">Insight</span></h3>
            <p className="text-[11px] text-slate-500 font-medium italic italic">Next patient coordination details.</p>
         </div>

         <GlassCard className="!p-8 bg-white border-indigo-50 shadow-2xl shadow-indigo-100/30 scale-105 origin-top translate-y-4">
            <div className="flex items-center gap-6 mb-8">
               <div className="w-16 h-16 rounded-3xl bg-indigo-600 shadow-xl shadow-indigo-100 flex items-center justify-center font-bold text-white text-2xl">J</div>
               <div className="space-y-1">
                  <p className="text-xl font-bold text-slate-900 leading-none">John Doe</p>
                  <p className="text-[10px] font-black uppercase text-indigo-500 tracking-[0.2em] pt-2 italic">Scheduled: 10:30am</p>
               </div>
            </div>
            ...
            <div className="space-y-8">
                  ...
                  <div className="space-y-3">
                     {[
                        ...
                        <div key={item.label} className="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100">
                           <span className="text-[10px] font-bold text-slate-600 italic">{item.label}</span>
               ...
               <Button className="w-full h-14 bg-indigo-600 hover:bg-slate-950 font-black text-xs uppercase tracking-widest text-white shadow-xl shadow-indigo-100 transition-all active:scale-95 group">
         ...
         <div className="pt-12 space-y-6">
            <div className="space-y-2">
               <h4 className="text-[10px] font-black uppercase text-slate-400 tracking-widest italic italic">Clinical Environment</h4>
               <p className="text-xs font-bold text-slate-700 italic italic">Room 402 - Level 4 Oncology</p>
            </div>
            <div className="flex gap-3">
               <Button variant="outline" className="flex-1 h-12 bg-white border-slate-100 text-slate-600 font-bold text-[10px] uppercase tracking-widest shadow-sm">View Map</Button>
               <Button variant="outline" className="flex-1 h-12 bg-white border-slate-100 text-slate-600 font-bold text-[10px] uppercase tracking-widest shadow-sm">Triage Desk</Button>
            </div>
         </div>
      </div>
    </div>
