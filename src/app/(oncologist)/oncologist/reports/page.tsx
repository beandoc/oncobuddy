    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-100 pb-10">
         <div className="space-y-2">
            ...
            <p className="text-slate-500 font-medium italic italic opacity-80 pt-2">Advanced panel performance metrics and PRO-CTCAE outcome analysis.</p>
         </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
         <GlassCard className="!p-8 rounded-[48px] border-white/50 bg-slate-950 text-white space-y-10 shadow-2xl shadow-slate-900/40">
            <div className="flex items-center justify-between">
               <h3 className="text-2xl font-black font-outfit italic italic tracking-tight text-white border-b-2 border-indigo-500 pb-2">Toxicity Distribution (G3+)</h3>
            ...
            <div className="space-y-6">
               {[
                  ...
                  <div key={item.name} className="space-y-2">
                     <div className="flex justify-between text-xs font-black uppercase text-indigo-100/50 tracking-widest">
                        <span>{item.name}</span>
         ...
         <div className="space-y-8">
            <h3 className="text-2xl font-black font-outfit italic italic tracking-tight text-slate-900 border-b-2 border-indigo-100 pb-2">Panel Longitudinal Trends</h3>
            <div className="grid grid-cols-1 gap-6">
               {[
                  ...
                  <GlassCard key={i} className="hover:bg-white border-white/50 !p-8 group hover:border-indigo-100 transition-all cursor-pointer">
                     <div className="flex items-center justify-between">
                        <div>
                           <h4 className="text-lg font-black font-outfit text-slate-900 group-hover:text-indigo-600 transition-colors italic">{card.title}</h4>
                           <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest mt-1 italic italic">Trailing 90 Days</p>
                        </div>
                        <div className={`text-${card.color}-600 font-black text-xl italic italic group-hover:scale-110 transition-transform`}>{card.trend}</div>
                     </div>
                  </GlassCard>
               ))}
            </div>
