...
export default async function RegistryPage() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-100 pb-10">
         <div className="space-y-2">
            <div className="flex items-center gap-2 mb-2">
               ...
               <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-[0.3em] font-serif">Registry Sync: Online</span>
            </div>
            ...
            <p className="text-slate-500 font-medium italic opacity-80 pt-2">Full-fidelity case inventory and oncological tracking for {institution?.institutionName || "Clinical Network"}.</p>
         </div>
         <div className="flex items-center gap-4">
            <Button className="h-14 px-8 bg-indigo-600 text-white rounded-[24px] font-bold text-xs uppercase tracking-wider shadow-sm hover:scale-105 transition-all flex items-center gap-3">
               <Database className="w-4 h-4" /> Global Search
            </Button>
            <Button variant="outline" className="h-14 px-8 rounded-[24px] border-slate-100 bg-white hover:bg-slate-50 font-bold text-xs uppercase tracking-wider flex items-center gap-2">
      ...
      {/* 2. Search & Filter Bar */}
      <GlassCard className="!p-4 bg-white/80 border-white/50 shadow-sm rounded-xl">
         <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
               ...
               <Button className="h-16 px-10 bg-slate-950 text-white rounded-2xl font-bold text-xs uppercase tracking-wider">Execute Search</Button>
            </div>
         </div>
      </GlassCard>
      ...
      <div className="p-32 text-center bg-slate-50/50 rounded-2xl border-2 border-dashed border-slate-100 relative overflow-hidden group">
         ...
         <div className="relative z-10 space-y-8">
            <div className="w-24 h-24 bg-white border-2 border-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mx-auto shadow-sm shadow-indigo-100/50 group-hover:rotate-12 transition-transform">
               <Database className="w-10 h-10" />
            </div>
            <div className="max-w-md mx-auto space-y-4">
               <h3 className="text-3xl font-bold font-outfit text-slate-900 italic tracking-tight">Access Restricted to <span className="text-indigo-600">Institutional PI</span></h3>
               <p className="text-slate-500 font-medium opacity-70">Global registry access requires Primary Investigator authorization. Please use the "My Patients" portal for direct clinical care.</p>
            </div>
            <div className="pt-6">
               <Button className="h-14 px-10 bg-indigo-600 text-white rounded-full font-bold text-xs uppercase tracking-wider shadow-sm hover:bg-slate-950 transition-all">Submit Access Token</Button>
            </div>
            <p className="text-[9px] text-slate-300 font-bold uppercase tracking-[0.5em] pt-12">Compliance standard: ICD-O-3 | SEER-18 | DPDPA</p>
         </div>
      </div>
    </div>
  );
